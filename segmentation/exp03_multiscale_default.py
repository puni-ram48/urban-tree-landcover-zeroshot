#!/usr/bin/env python3
"""
Experiment 03: Multi-scale segmentation with default SAM parameters.
        ...
        try:
            ...
            with utils.Timer() as fusion_timer:
                fused_masks = utils.fuse_multiscale_masks(
                    ...
                    min_pixels=config.EXP3_PARAMS["fusion_min_pixels"],
                    merge_threshold=config.EXP3_PARAMS["fusion_merge_threshold"],
                )
...
# Main
def main():
    params = config.EXP3_PARAMS

    print("=" * 70)
    print("EXPERIMENT 03: MULTI-SCALE SEGMENTATION — DEFAULT PARAMETERS")
    print("=" * 70)
    ...
    logger.info("=" * 70)
    logger.info("EXPERIMENT 03: MULTI-SCALE SEGMENTATION — DEFAULT PARAMETERS")
    logger.info("=" * 70)
